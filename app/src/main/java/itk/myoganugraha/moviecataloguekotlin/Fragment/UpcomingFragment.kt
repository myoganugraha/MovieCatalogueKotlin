...
class UpcomingFragment : Fragment() {
    ...
    private fun setupList() {
        ...
        var call = apiService.getUpcomingMovies("02c64ad2e3c5f83aaee9677f967b4327", "en-US")
        ...
        call.enqueue(object : Callback<MovieResponse> {
            ...
            override fun onResponse(call: Call<MovieResponse>, response: Response<MovieResponse>) {
                ...
                recyclerView_fragment_upcoming.adapter = adapter
                recyclerView_fragment_upcoming?.layoutManager = LinearLayoutManager(mContext)
            }
        })
    }
